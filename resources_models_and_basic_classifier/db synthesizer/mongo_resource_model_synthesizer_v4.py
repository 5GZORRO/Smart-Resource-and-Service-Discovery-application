...
edgeRPvalidFor=[[[],[]] for i in range(400)]
edgerelatedParty=[[] for i in range(400)]
for i in range(100): 
...
for i in range(400): 
    index1=random.choice([0,1,2])
    edgeRPvalidFor[i]={'endDateTime':endDateTime_list[index1],'startDateTime':startDateTime_list[index1]}
    edgerelatedParty[i]=[{'id':str(uuid.uuid4()),'href':'http://serverLocation:port/partyManagement/partyRole/1234',\
                          'role':"Owner",'name':random.choice(["Gustave Flaubert","Boris Johnson","Fiodor Dostojewski",\
                                                               "Wolfgang Amadeus"]),"validFor":edgeRPvalidFor[i]}]    
edgecategory=[[] for i in range(400)]
for i in range(400): 
    edgecategory[i]=[{'id':str(uuid.uuid4()),"href": "http://serverlocation:port/catalogManagement/category/12",\
                      "version":"2.0","@referredType": "Category","name": "Edge offerings"}] 

edgeplace=[[] for i in range(400)]
for i in range(400): 
    adresses=["Calle Quijote 5, Madrid Spain","Lamias 3, Athens Greece","new york road 2, Madrid Spain","Themistokleous 43, Athens Greece"]
    adr=["Madrid Spain","Athens Greece","Madrid Spain","Athens Greece"]
    index1=random.choice([0,1,2,3])
    edgeplace[i]=[{'id':str(uuid.uuid4()),"@referredType": "Place","href": "http://serverlocation:port/marketSales/place/12",\
                   "geoLocationUrl": "http://mymaps.com/YURZZ",\
                   "address": adresses[index1],\
                   "role": "default delivery","name": adr[index1]}] 
...
cloudRPvalidFor=[[[],[]] for i in range(400)]
cloudrelatedParty=[[] for i in range(400)]
for i in range(100): 
    index0=random.choice([i for i in range(50)])
...
for i in range(400): 
    index1=random.choice([0,1,2])
    cloudRPvalidFor[i]={'endDateTime':endDateTime_list[index1],'startDateTime':startDateTime_list[index1]}
    cloudrelatedParty[i]=[{'id':str(uuid.uuid4()),'href':'http://serverLocation:port/partyManagement/partyRole/1234',\
                           'role':"Owner",'name':random.choice(["Gustave Flaubert","Boris Johnson","Fiodor Dostojewski",\
                                                                "Wolfgang Amadeus"]),"validFor":cloudRPvalidFor[i]}]    
cloudcategory=[[] for i in range(400)]
for i in range(400): 
    cloudcategory[i]=[{'id':str(uuid.uuid4()),"href": "http://serverlocation:port/catalogManagement/category/13",\
                      "version":"2.0","@referredType": "Category","name": "Cloud offerings"}] 


cloudplace=[[] for i in range(400)]
for i in range(400): 
    adresses=["Quijote 8, Madrid Spain","Peiraiws 2, Athens Greece"," Pessoa 21, Madrid Spain","Themistokleous 87, Athens Greece"]
    adr=["Madrid Spain","Athens Greece","Madrid Spain","Athens Greece"]
    index1=random.choice([0,1,2,3])
    cloudplace[i]=[{'id':str(uuid.uuid4()),"@referredType": "Place","href": "http://serverlocation:port/marketSales/place/12",\
                   "geoLocationUrl": "http://mymaps.com/YURZZ",\
                   "address": adresses[index1],\
                   "role": "default delivery","name": adr[index1]}]
...
rancategory=[[] for i in range(400)]
for i in range(400): 
    rancategory[i]=[{'id':str(uuid.uuid4()),"href": "http://serverlocation:port/catalogManagement/category/14",\
                      "version":"2.5","@referredType": "Category","name": "Ran offerings"}] 

ranplace=[[] for i in range(400)]
for i in range(400): 
    adresses=["Quijote 8, Madrid Spain","Peiraiws 2, Athens Greece"," Pessoa 21, Madrid Spain","Themistokleous 87, Athens Greece"]
    adr=["Madrid Spain","Athens Greece","Madrid Spain","Athens Greece"]
    index1=random.choice([0,1,2,3])
    ranplace[i]=[{'id':str(uuid.uuid4()),"@referredType": "Place","href": "http://serverlocation:port/marketSales/place/12",\
                   "geoLocationUrl": "http://mymaps.com/YURZZ",\
                   "address": adresses[index1],\
                   "role": "default delivery","name": adr[index1]}]   
...
spectrumcategory=[[] for i in range(400)]
for i in range(400): 
    spectrumcategory[i]=[{'id':str(uuid.uuid4()),"href": "http://serverlocation:port/catalogManagement/category/17",\
                      "version":"2.5","@referredType": "Category","name": "Spectrum offerings"}]     

spectrumplace=[[] for i in range(400)]
for i in range(400): 
    adresses=["Quijote 48, Madrid Spain","Peiraiws 67, Athens Greece"," Pessoa 21, Madrid Spain","Themistokleous 7, Athens Greece"]
    adr=["Madrid Spain","Athens Greece","Madrid Spain","Athens Greece"]
    index1=random.choice([0,1,2,3])
    spectrumplace[i]=[{'id':str(uuid.uuid4()),"@referredType": "Place","href": "http://serverlocation:port/marketSales/place/12",\
                   "geoLocationUrl": "http://mymaps.com/YURZZ",\
                   "address": adresses[index1],\
                   "role": "default delivery","name": adr[index1]}]
...
vnfRPvalidFor=[[[],[]] for i in range(400)]
vnfrelatedParty=[[[],[],[],[]] for i in range(400)]
for i in range(100): 
    index0=random.choice([i for i in range(50)])
...
for i in range(400): 
    index1=random.choice([0,1,2])
    vnfRPvalidFor[i]={'endDateTime':endDateTime_list[index1],'startDateTime':startDateTime_list[index1]}
    vnfrelatedParty[i]=[{'id':str(uuid.uuid4()),'href':'http://serverLocation:port/partyManagement/partyRole/1234',\
                           'role':"Owner",'name':random.choice(["Gustave Flaubert","Boris Johnson","Fiodor Dostojewski",\
                                                                "Wolfgang Amadeus"]),"validFor":vnfRPvalidFor[i]}]    

vnfcategory=[[] for i in range(400)]
for i in range(400): 
    vnfcategory[i]=[{'id':str(uuid.uuid4()),"href": "http://serverlocation:port/catalogManagement/category/19",\
                      "version":"2.5","@referredType": "Category","name": "Vnf offerings"}]  
    
        
vnfplace=[[] for i in range(400)]
for i in range(400): 
    adresses=["Quijote 48, Madrid Spain","Peiraiws 67, Athens Greece"," Pessoa 21, Madrid Spain","Themistokleous 7, Athens Greece"]
    adr=["Madrid Spain","Athens Greece","Madrid Spain","Athens Greece"]
    index1=random.choice([0,1,2,3])
    vnfplace[i]=[{'id':str(uuid.uuid4()),"@referredType": "Place","href": "http://serverlocation:port/marketSales/place/12",\
                   "geoLocationUrl": "http://mymaps.com/YURZZ",\
                   "address": adresses[index1],\
                   "role": "default delivery","name": adr[index1]}]        
...
for t in range(1):
 for post_number in range(100): 
    ...
    post_edge_resource = {
        ...
        "version": "v2",        
        'category': random.choice(edgecategory),
        "validFor":random.choice(edgevalidFor),        
        'place':random.choice(edgeplace),
        'relatedParty':random.choice(edgerelatedParty),           
    ...
    post_edge_resource = {
        ...
        'category': random.choice(edgecategory),
        "validFor":random.choice(edgevalidFor),        
        'place':'virtual resource has no fixed location', 
        'relatedParty':random.choice(edgerelatedParty),              
        'resourceSpecification':random.choice(edgeresourceSpecification)
    }
    result = posts1.insert_one(post_edge_resource)
 ...
 for post_number in range(100):    
    ...
    post_cloud_resource = {
        ...
        "lifecycleStatus": "Active",
        "version": "v2",        
        'category':random.choice(cloudcategory),
        "validFor":random.choice(edgevalidFor),        
        'place':random.choice(cloudplace), 
        'relatedParty':random.choice(cloudrelatedParty),              
 ...
 for post_number in range(200):   
    ...
    post_ran_resource = {
        ...
        "lifecycleStatus": "Active",
        "version": "v2",
        "category": random.choice(rancategory),
        "validFor":random.choice(ranvalidFor),
        'place':random.choice(ranplace),        
 ...
 for post_number in range(200): 
    ...
    post_spectrum_resource = {
        ...
        "version": "v2",
        "category": random.choice(spectrumcategory),
        "validFor":random.choice(spectrumvalidFor),
        'place':random.choice(spectrumplace),        
 ...
 for post_number in range(200): 
    ...
    post_vnf_resource = {
        ...
        "lastUpdate": random.choice(LAST_UPDATE_LIST),
        "version": "v1.3",
        "category": random.choice(vnfcategory),
        "validFor":random.choice(vnfvalidFor),         
        'place':random.choice(vnfplace), 
        'relatedParty':random.choice(vnfrelatedParty),        
